...
use App\Models\background_coloring as model;

class background_coloring extends Controller
{
public static $model;
...
public static function index()
{
    ...
    return view('dashboard.background_coloring.index',compact("records","totalPages",'currentPage'));
}   
...
public static function createUpdate(Request $request){
    ...
    $messagesAr=[
        ...
        "color.required"     =>"يجب ادخال الاسم",
