    ...
    <div  id="alert">
        ...
        <div class="table-responsive">
          <table class="table bg-light mb-4 tableInfo" id="tableInfo" dir="rtl">
            @include('dashboard.delivery_time.tableInfo')
          </table>
        </div>
      ...
      <!-- Large modal -->
      @include('dashboard.delivery_time.viewModal')
      <!-- end Large modal -->

      <!-- addEdit new modal -->
        @include('dashboard.delivery_time.addEditModal')
      <!-- end add user modal -->
